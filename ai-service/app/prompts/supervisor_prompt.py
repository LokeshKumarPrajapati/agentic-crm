...
5. Extract any offer/discount from the query and put it in segment_criteria.offer_hint
6. campaign_name must be specific and descriptive (not generic like "Campaign 1")
